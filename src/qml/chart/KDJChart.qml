...
BaseChart {
    ...
    property color kColor: '#222222'
    property color dColor: '#ff8802'
    property color jColor: '#e66de6'
        ...
        RectangleWithBorder {
            ...
            RowLayout {
                ...
                Text {
                    ...
                    Layout.rightMargin: 10
                    color: kColor
                    text: 'K: ' + Util.formatStockText(parent.kdjData.JieGuo[0], 3, '', false);
                }
                Text {
                    Layout.fillHeight: true
                    Layout.alignment: Qt.AlignLeft
                    ...
                    Layout.rightMargin: 10
                    color: dColor
                    text: 'D: ' + Util.formatStockText(parent.kdjData.JieGuo[1], 3, '', false);
                }
                Text {
                    Layout.fillHeight: true
                    Layout.alignment: Qt.AlignLeft
                    ...
                    Layout.rightMargin: 10
                    color: jColor
                    text: 'J: ' + Util.formatStockText(parent.kdjData.JieGuo[2], 3, '', false);
                }
                Item {
                    Layout.fillHeight: true
    ...
    function drawChart() {
        ...
        cache.forEach(function(eachData, index) {
            ...
            if (!isNaN(x)) {
                kPoints.push([x, yAxis.getY(eachData.JieGuo[0])]);
                dPoints.push([x, yAxis.getY(eachData.JieGuo[1])]);
                jPoints.push([x, yAxis.getY(eachData.JieGuo[2])]);
            }
        });
